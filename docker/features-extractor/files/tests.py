...
class MyTestCase(unittest.TestCase):
    ...
    def test_two_methods_with_traces_and_vp(self):
        mapper = Mapper(
            ...
            {"nodes": [{"name": "Class1", "types": [], "methods": [{"name": "method1", "number": 2}, {"name": "method2", "number": 3}], "constructors": []}], "links": []})
        mapper.make_mapping()
        result = mapper.calculate_measures()
    ...
    def test_two_methods_with_traces_and_but_homonym_in_another_class_is_vp(self):
        mapper = Mapper(
            [],
            [Method("method1", "Class1", ["feature1"]), Method("method2", "Class1", ["feature2"])],
            {"nodes": [{"name": "Class1", "types": [], "methods": [{"name": "method1", "number": 2}], "constructors": []}, {"name": "Class2", "types": [], "methods": [{"name": "method2", "number": 3}], "constructors": []}], "links": []})
        mapper.make_mapping()
        result = mapper.calculate_measures()
        self.assertEqual(1, result.get_true_positives())
        self.assertEqual(1, result.get_false_positives())
    ...
    def test_constructor_true_positive(self):
        mapper = Mapper(
            ...
            {"nodes": [{"name": "Class1", "types": [], "methods": [], "constructors": [{"name": "Class1", "number": 2}]}], "links": []})
        mapper.make_mapping()
        result = mapper.calculate_measures()
        self.assertEqual(1, result.get_true_positives())
        self.assertEqual(0, result.get_false_positives())
